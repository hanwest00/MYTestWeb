...
namespace MYORM.Interfaces
{
    public interface ITable<T>
    {
        ...
        void Where(IList<MYDBCondition> conds,params System.Data.Common.DbParameter[] dbParams);
		...
		IList<T> Select(int page, int pageNum, OrderBy pageOrder, IList<MYDBCondition> rowConds, params string[] fields);
