...
namespace MYORM
{
    public abstract class MYTableBase<T> : Interfaces.ITable<T> where T : MYORM.MYItemBase
    {
        ...
        public abstract void Where(IList<MYDBCondition> conds, params DbParameter[] dbParams);
        ...
        public abstract IList<T> Select(int page, int pageNum, OrderBy pageOrder, IList<MYDBCondition> rowConds, params string[] fields);
